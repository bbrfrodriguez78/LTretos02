...
public class reqresDelayedResponseTest {
    ...
    @Test //Consulta delay response
    public void restDelayedResponse() throws URISyntaxException, IOException, InterruptedException{
        ...
        String validationSchema =  JsonSchemaValidator.validateJsonAgainstSchema(response.body(), "ReqresDelayedSchema.json");
